...
// Icons for filters
import {
  AiFillHeart,        // for Favorites
  AiOutlineFolderOpen, // for Category
  AiOutlineTag,        // for Type
  AiOutlineBgColors,   // for Color
  AiOutlineShop,       // for Brand
  AiOutlineDollarCircle, // for Price
  AiOutlinePlusCircle,  // plus icon
  AiOutlineDelete       // trash icon
} from 'react-icons/ai';
            ...
            <Modal.Body>
              ...
              <div style={{ textAlign: 'center', marginTop: '10px' }}>
                <button
                  ...
                  onClick={() => alert('Generate fit with this piece! (placeholder)')}
                >
